    ...
    <div id="PersonalHistoryStatement">
      ...
      <div className="columns body-content">
        <div className="column">
          ...
          <p>
            <span className="has-text-weight-semibold field-label">Alias:</span>
            {alias}
          </p>
          <p>
            <span className="has-text-weight-semibold field-label">
        ...
        <div className="column">
          ...
          <p>
            <span className="has-text-weight-semibold field-label">Tribe:</span>
      ...
      <div className="columns body-content">
        ...
        <div className="column">
          <p>
            <span className="has-text-weight-semibold field-label">Eyes:</span>
            {data.physical_description.eyes || 'n/a'}
          </p>
          <p>
            <span className="has-text-weight-semibold field-label">Hair:</span>
            {data.physical_description.hair || 'n/a'}
          </p>
          <p>
            <span className="has-text-weight-semibold field-label">Build:</span>
      ...
      <div className="title is-5">F. Relatives working in the government:</div>
      <div className="columns body-content">
        <div className="column">
          <Relatives data={data.relatives.government_working} />
        </div>
      </div>
      <div className="title is-5">G. Relatives affiliated with LCM organ:</div>
      <div className="columns body-content">
        <div className="column">
